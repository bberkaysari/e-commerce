...
class VariantController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        try {
            ...
            return $this->handleException($e, 'VariantController@index');
        }
    }
    ...
    public function store(StoreVariantRequest $request): JsonResponse
    {
        try {
            ...
            return $this->handleException($e, 'VariantController@store');
        }
    }
    ...
    public function show(int $id): JsonResponse
    {
        try {
            ...
            return $this->handleException($e, 'VariantController@show');
        }
    }
    ...
    public function update(int $id, StoreVariantRequest $request): JsonResponse
    {
        try {
            ...
            return $this->handleException($e, 'VariantController@update');
        }
    }
}
